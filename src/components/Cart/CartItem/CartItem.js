...
import * as actionsTypes from '../../../Redux/actions';
...
const mapDispatchToProps = (dispatch)=>{
  return {
    removeFromCart : (id)=>dispatch({type:actionsTypes.REMOVE_FROM_CART , payload:{id:id}}),
    adjustQty : (id , qty)=> dispatch({type:actionsTypes.UPDATE_QTY , payload:{id:id , qty:qty}})
  }
}
